...
APP_BUNDLE="$APP_BUNDLE" "$ROOT_DIR/script/sign_app.sh"
APP_BUNDLE="$APP_BUNDLE" "$ROOT_DIR/script/notarize_app.sh"
APP_BUNDLE="$APP_BUNDLE" DMG_PATH="$DMG_PATH" "$ROOT_DIR/script/make_dmg.sh"
